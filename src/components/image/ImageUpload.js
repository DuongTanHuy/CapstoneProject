...
const ImageUpload = (props) => {
  ...
  return (
    ...
    >
      ...
      />
      {progress !== 0 && !image && (
        <div className="loading w-16 h-16 border-8 border-primary border-t-transparent animate-spin absolute z-10 rounded-full"></div>
      )}
      {!image && progress === 0 && (
      ...
      {!image && (
        <div
          className="absolute w-10 h-1 bg-primary bottom-0 left-0 transition-all image-upload-progress"
          style={{
